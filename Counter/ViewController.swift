...
//MARK: - переменные и константы
    ...
    private var counter: UInt8 = UserDefaults.standard.object(forKey: "currentValue") as? UInt8 ?? 0 {
        didSet {
            updateCounterValue()
            setColorLabel()
            isBestNum()
...
//MARK: - вспомогательные функции
    ...
    //сохранение последнего значения в хранилище
    private func saveToWarehouse() {
        UserDefaults.standard.set(counter, forKey: "currentValue")
    }
}
